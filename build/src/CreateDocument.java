...
*/
  ...
  static final String CREATE_COTX_TAG_DESCR = """
      ...
      <div style='margin-top:0.5em'>See also
      <a href='#cbor.tag.cotxid'>cotxId</a> and
      <a href='#cbor.tag.cotxobject'>cotxObject</a>.</div>""";
  ...
  CreateDocument(String templateFileName, String documentFileName) {
    ...
    addWrapper(DataTypes.CBOR_FLOAT, W_FLOAT_DESCR)
        ...
        .addParameter("value", DataTypes.JS_NUMBER, W_CREFLOAT1632_P1_DESCR)
        .addParameter("exact", DataTypes.JS_BOOLEAN, W_CREFLOAT1632_P2_DESCR)
